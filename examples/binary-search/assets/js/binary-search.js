...
Description : Implementation of Binary Search Algorithm
    ...
    Binary search is a divide-and-conquer algorithm used to efficiently search for a 
    target value in a sorted array. It repeatedly divides the search space in half by 
    comparing the target with the middle element, eliminating the half where the target 
    cannot exist. 
    
    This process continues until the target is found or the search space 
    is empty, achieving logarithmic time complexity.
